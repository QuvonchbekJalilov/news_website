...
?>
<?php \frontend\widgets\Header::widget()?>
                ...
                ?>
                    <div class="item px-2">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="<?=$image?>" width="100" alt="<?=$news->title?>"></div>
                            <div>
                                <a href="<?= Yii::$app->urlManager->createUrl(['site/single', 'id' => $news->id]) ?>" class="d-block fh5co_small_post_heading"><span class=""><?= $news->title ?></span></a>
                                <div class="c_g"><i class="fa fa-clock-o"></i> <?= Yii::$app->formatter->asDate($news->created_at) ?></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
